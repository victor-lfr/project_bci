...
void koala::throw_invalid_header(unsigned char expected, unsigned char got) {
...
void koala::checkheader(unsigned char * header, unsigned long int& width, unsigned long int& height, unsigned long int& size) {
  int i;
...
void koala::init_source(j_decompress_ptr p) {
}

boolean koala::fill_input_buffer(j_decompress_ptr p) {
  return FALSE;
}

void koala::skip_input_data(j_decompress_ptr p, long int l) {
}

boolean koala::resync_to_restart(j_decompress_ptr p, int l) {
  return FALSE;
}

void koala::term_source(j_decompress_ptr p) {
}

void koala::error_exit(j_common_ptr p) {
}

void koala::emit_message(j_common_ptr p, int l) {
}

void koala::output_message(j_common_ptr p) {
}

void koala::format_message(j_common_ptr p, char * s) {
}

void koala::reset_error_mgr(j_common_ptr p) {
}

int koala::jlg_decompress(unsigned char * inputbuffer, int width, int height, int size, int width_old, int height_old, unsigned char** decompressed_image, unsigned char ** jpeg_linebuffer)
{
...
void koala::open_connection(std::string hostname, std::string port,
...
void koala::close_connection(ConnectionParams& params) {
  params.socket.close();
...
void koala::read_image(ConnectionParams& params) {
