...
// Horizontal range
std::pair<int, int> koala::CameraPositionClient::pan_range = {-100, 100}; // deg
// Vertical range
std::pair<int, int> koala::CameraPositionClient::tilt_range = {0, 100}; // deg

koala::CameraPositionClient::CameraPositionClient() {}

int koala::CameraPositionClient::bound(int value, const std::pair<int, int>& range) {
...
void koala::CameraPositionClient::connect(std::string hostname, std::string port) {
...
void koala::CameraPositionClient::close() {
  socket.close();
}

void koala::CameraPositionClient::read(int& pan, int& tilt)  {
...
void koala::CameraPositionClient::write(int pan, int tilt)  {    
