...
koala::WheelServer::WheelServer() {}

void koala::WheelServer::connect(std::string hostname, std::string port) {
...
void koala::WheelServer::close() {
  socket.close();
}


koala::IRReader::IRReader(WheelServer& serv): server(serv) {}

double koala::IRReader::get_dist_from_ir(int ir_value)
{
...
void koala::IRReader::read(std::array<double,nb_ir_sensors>& ranges, std::array<int, nb_ir_sensors>& raw) {
...
koala::WheelSpeed::WheelSpeed(WheelServer& serv): server(serv) {}

void koala::WheelSpeed::read(double& linear, double& angular) const {
...
void koala::WheelSpeed::write(double linear, double angular) const {
