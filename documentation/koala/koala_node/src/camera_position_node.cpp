...
void decode_command(const geometry_msgs::PointStampedConstPtr& camera_position_msg, koala::CameraPositionClient& client) {
...
int main(int argc, char* argv[]) {
 ...
 // Open the connection to the camera position server
  koala::CameraPositionClient camera_client;
